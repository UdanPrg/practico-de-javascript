...
function medianaSalarios(lista){
    ...
    if(esPar(lista.length) == true){
        ...
        const mediana = calcularPromedioAritmetica([personitaMitad1, personitaMitad2]);
        return mediana;
    }else{
...
// Mediana General
const salariosColSorted = salariosCol.sort(function(salaryX,salaryY){
    return salaryX - salaryY;
});
